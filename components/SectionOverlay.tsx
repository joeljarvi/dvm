  ...
  return (
    <CustomCursorTarget asChild>
      <button
        ...
        className={`group/overlay  absolute z-900 inset-0 bg-background/60 hover:bg-background/70 backdrop-blur-xs transition-all duration-700 ease-out flex items-start justify-center cursor-pointer ${
