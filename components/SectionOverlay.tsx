  ...
  return (
    <CustomCursorTarget asChild>
      <button
        ...
        className={`group/overlay  absolute z-900 inset-0 bg-background/60 hover:bg-background/70  backdrop-blur-xs [transition:background-color_200ms_ease-out,opacity_700ms_cubic-bezier(0.22,1,0.36,1)] flex items-start justify-center cursor-pointer ${
