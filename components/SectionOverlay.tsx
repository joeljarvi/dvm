...
export default function SectionOverlay({
  ...
  return (
    ...
    >
      ...
      {/* <h2
        className={`capitalize ${section === "personal" ? "text-left lg:rotate-0" : "text-right lg:rotate-0"} font-selecta text-[0.8rem] h-14 px-5.5 pt-6 tracking-wide w-full  font-normal text-neutral-400 transition-colors duration-200 ease-out group-hover/overlay:text-blue-700 group-active/overlay:text-blue-700`}
      >
        {section}
      </h2> */}
    </button>
