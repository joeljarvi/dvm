...
export default function ProjectDetail({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-wrap lg:flex-nowrap lg:flex-row gap-x-0 w-full lg:w-max p-24 lg:py-8 gap-y-24 items-center justify-center lg:justify-center-safe lg:h-[66.6dvh]">
